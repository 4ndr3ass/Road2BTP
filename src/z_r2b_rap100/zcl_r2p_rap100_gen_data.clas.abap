CLASS zcl_r2p_rap100_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_r2p_rap100_gen_data IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA:
      group_id   TYPE string VALUE 'R2B',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zr2b_100_atrav.

    "insert travel demo data
    INSERT zr2b_100_atrav  FROM (
        SELECT
    ...
    out->write( |[RAP100] Demo data generated for table zr2b_100_atrav{ group_id }. | ).
